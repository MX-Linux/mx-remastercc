...
namespace
{
void setupDocDialog(QDialog &dialog, QTextBrowser *browser, const QString &title, const bool largeWindow)
{
...
void showHtmlDoc(const QString &url, const QString &title, const bool largeWindow)
{
    QDialog dialog;
...
void displayDoc(const QString &url, const QString &title, const bool largeWindow)
{
